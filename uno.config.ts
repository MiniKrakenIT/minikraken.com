...
export default defineConfig({
	...
	/*theme: {
		colors: {
			...
			error:
				'color-mix(in oklch, var(--color-error) calc(<alpha-value> * 100%), transparent)',
			'error-content':
			...
			neutral:
				'color-mix(in oklch, var(--color-neutral) calc(<alpha-value> * 100%), transparent)',
			'neutral-content':
			...
			success:
				'color-mix(in oklch, var(--color-success) calc(<alpha-value> * 100%), transparent)',
			'success-content':
				'color-mix(in oklch, var(--color-success-content) calc(<alpha-value> * 100%), transparent)',
			warning:
				'color-mix(in oklch, var(--color-warning) calc(<alpha-value> * 100%), transparent)',
			'warning-content':
