<script module lang="ts">
	import type { Color, Shape, Size, Variant } from '$components/properties'
	...
	export type Props = (
		...
		color?: ResponsiveProperty<ButtonColors> | ButtonColors
		size?: ResponsiveProperty<ButtonSizes>
		variant?: ResponsiveProperty<ButtonVariants>
		shape?: ResponsiveProperty<ButtonShapes>
		href?: string | null
		children: Snippet
	}
</script>
