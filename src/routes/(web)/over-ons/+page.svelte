	...
	<main class="isolate">
				...
				<div class="mx-auto max-w-7xl px-6 pt-36 pb-32 sm:pt-60 lg:px-8 lg:pt-32">
					<div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
						<div class="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
							<h1 class="text-5xl font-semibold tracking-tight text-pretty sm:text-7xl">
								We’re changing the way people connect
							</h1>
							<p
								class="text-passive-100 mt-8 text-lg font-medium text-pretty sm:max-w-md sm:text-xl/8 lg:max-w-none"
							>
			...
			<div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
				...
				<div class="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
					<div class="lg:w-full lg:max-w-2xl lg:flex-auto">
						<p class="text-passive-100 text-xl/8">
						...
						<p class="text-passive-100 mt-10 max-w-xl text-base/7">
					...
					<div class="lg:flex lg:flex-auto lg:justify-center">
						<dl class="w-64 space-y-8 xl:w-80">
							<div class="flex flex-col-reverse gap-y-4">
								<dt class="text-passive-100 text-base/7">Transactions every 24 hours</dt>
								<dd class="text-5xl font-semibold tracking-tight">44 million</dd>
							</div>
							<div class="flex flex-col-reverse gap-y-4">
								<dt class="text-passive-100 text-base/7">Assets under holding</dt>
								<dd class="text-5xl font-semibold tracking-tight">$119 trillion</dd>
							</div>
							<div class="flex flex-col-reverse gap-y-4">
								<dt class="text-passive-100 text-base/7">New users annually</dt>
		...
		<div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
			<div class="mx-auto max-w-2xl lg:mx-0">
				...
				<p class="text-passive-100 mt-6 text-lg/8">
			...
			>
				<div>
					...
					<dd class="text-passive-100 mt-1">
		...
		<div class="relative isolate -z-10 mt-32 sm:mt-48">
			<div class="mx-auto max-w-7xl px-6 lg:px-8">
				...
				<div class="mt-3 flex flex-wrap justify-center gap-x-12 gap-y-3">
		...
		<div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-48 lg:px-8">
			...
			>
				<li>
					...
					<p class="text-passive-100 text-sm/6">Co-Founder / CTO</p>
				</li>
			</ul>
		</div>
	</main>
